...
class DireccionsControllerTest < ActionController::TestCase
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post :create, direccion: { calle: @direccion.calle, comuna: @direccion.comuna, cuidad: @direccion.cuidad, numero: @direccion.numero, pais: @direccion.pais, usuario_id: @direccion.usuario_id }
    end
  ...
  test "should update direccion" do
    patch :update, id: @direccion, direccion: { calle: @direccion.calle, comuna: @direccion.comuna, cuidad: @direccion.cuidad, numero: @direccion.numero, pais: @direccion.pais, usuario_id: @direccion.usuario_id }
    assert_redirected_to direccion_path(assigns(:direccion))
  end
